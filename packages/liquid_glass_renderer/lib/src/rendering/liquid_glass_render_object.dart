...
abstract class LiquidGlassRenderObject extends RenderProxyBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    // Shapes can briefly report an empty geometry during their first layout
    // frame (notably dialogs and overlays). Building a zero-sized ui.Image
    // throws on Android. Skip that transient frame and let the next layout
    // paint the live glass normally.
